...
SELECT mdate, team1, COUNT(player) AS score1, team2, COUNT(player) AS score2 FROM game
JOIN goal
...
SELECT mdate,
  team1,
  CASE WHEN teamid = team1 THEN COUNT(team1) END score1,
  team2,
  CASE WHEN teamid = team2 THEN COUNT(team2) END score2
  FROM game 
JOIN goal 
ON goal.matchid = game.id
GROUP BY mdate, team1, team2, teamid, matchid
ORDER BY mdate;
